    ...
    <header className="top-navbar" style={{ borderBottom: '1px solid var(--border-subtle)', background: '#050505' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#ffffff' }}>
          Console d'Administration & Gestion des Clients
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        {/* Switch to Operational CRM Workspace ("Espace Traitement CRM") */}
        <Link 
          href="/campaigns" 
          ...
          title="Aller sur l'espace opérationnel CRM (Campagnes, Prospects, Envois)"
        >
          <ArrowLeft size={14} />
          <span>Espace Traitement CRM</span>
        </Link>
      </div>
    </header>
  );
